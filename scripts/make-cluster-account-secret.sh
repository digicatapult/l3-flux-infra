...
print_usage() {
  echo "Makes a kubernetes secret containing keys for a l3 account. The final line of this script will output a JSON object containing the new account's accountId."
  echo ""
  echo "Usage:"
