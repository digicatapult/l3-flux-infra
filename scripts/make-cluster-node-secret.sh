...
print_usage() {
  echo "Makes a kubernetes secret containing keys for a l3-node. The final line of this script will output a JSON object containing the new node's PeerId, AuraId and GrandpaId."
  echo ""
  echo "Usage:"
  ...
  echo "  -n <namespace>  Namespace in which to create the secret. Defaults to l3"
}
